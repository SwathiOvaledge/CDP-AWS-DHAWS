...
CREATE
OR REPLACE EXTERNAL TABLE LOAD_STG.BTP_CVC_DS_FMNO_WBS_HOURS_INCR_EXT(
  ...
  CLIENT_HOURS NUMBER AS ($1:CLIENT_HOURS::NUMBER),
  HOURS NUMBER AS ($1:HOURS::NUMBER),
  ...
  LOAD_DATE TIMESTAMP_NTZ(9) AS (TO_TIMESTAMP
           (
             ...
             'YYYY-MM-DD'
           )) --TODO: Load_Date is required? Not being used for incremental data extraction here
    )
LOCATION=@STG_ENGAGE/btp/incr/formatted/fct-btphana.cvc-ds-fmno-wbs-hours/
AUTO_REFRESH = TRUE
